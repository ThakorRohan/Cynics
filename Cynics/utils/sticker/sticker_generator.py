...
urlretrieve(
    ...
    'Cynics/utils/sticker/NotoSansDisplay-Bold.ttf',
)

urlretrieve(
    'https://github.com/pokurt/Fonts/raw/master/OpenSans-Regular.ttf',
    'Cynics/utils/sticker/OpenSans-Regular.ttf',
)
...
async def create_sticker(client, message):
    ...
    try:
        ...
        urlretrieve(
            ...
            'Cynics/utils/sticker/default.jpg',
        )
        photo = 'Cynics/utils/sticker/default.jpg'
