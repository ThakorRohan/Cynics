...
if DB_AVAILABLE:
    from Cynics.plugins.assistant.database.stickers_db import (
        get_sticker_set,
        get_stanim_set,
    )
...
async def kang_stickers(client, message):
    ...
    async with stickers_lock:
        ...
        if message.reply_to_message and message.reply_to_message.sticker:
            ...
            if doc_mime == 'application/x-tgsticker':
                ...
                await client.download_media(
                    ...
                    file_name='Cynics/cache/sticker.tgs',
                )
            else:
                await client.download_media(
                    message.reply_to_message.sticker,
                    file_name='Cynics/cache/sticker.png',
                )
        ...
        if (
            ...
            im = Image.open('Cynics/cache/sticker.png')
            ...
            im.save('Cynics/cache/sticker.png', 'PNG')
        ...
        if (
            ...
            os.remove('Cynics/cache/sticker.png')
            return
        if (
            message.reply_to_message.sticker
            and mime_type == 'application/x-tgsticker'
        ):
            await client.send_document('@Stickers', 'Cynics/cache/sticker.tgs')
            os.remove('Cynics/cache/sticker.tgs')
        else:
            await client.send_document('@Stickers', 'Cynics/cache/sticker.png')
            os.remove('Cynics/cache/sticker.png')
