...
if DB_AVAILABLE:
    from Cynics.plugins.database.cloner_db import (
        backup_indentity,
        restore_identity,
    )
...
profile_photo = 'Cynics/downloads/pfp.jpg'
...
async def clone(client, message):
    ...
    dl = await client.download_media(q[0], file_name='Cynics/downloads/pp.png')
    await app.set_profile_photo(photo='Cynics/downloads/pp.png')
