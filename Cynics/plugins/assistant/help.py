...
from Cynics.utils.misc import paginate_modules
from Cynics.plugins.chats import get_msgc
from Cynics.languages.strings import tld

if DB_AVAILABLE:
    from Cynics.plugins.database.chats_db import get_all_chats
    from Cynics.plugins.database.notes_db import get_all_selfnotes
