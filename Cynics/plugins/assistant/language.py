from Cynics.plugins.database.lang_db import switch_to_locale, prev_locale
from Cynics.languages.strings import tld
from Cynics.languages.list_locale import list_locales
import re
...
from Cynics import setbot, Owner
