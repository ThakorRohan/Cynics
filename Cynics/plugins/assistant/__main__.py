...
from Cynics import ASSISTANT_VERSION
from Cynics import BotUsername
from Cynics import DB_AVAILABLE
from Cynics import Cynics_IMG
from Cynics import OwnerName
from Cynics import setbot
from Cynics import USERBOT_VERSION
from Cynics.languages.strings import tld
from Cynics.utils import filt
from Cynics.plugins.assistant.settings import get_button_settings
from Cynics.plugins.assistant.settings import get_text_settings
from Cynics.utils.dynamic_filt import dynamic_data_filter

if DB_AVAILABLE:
    from Cynics.plugins.database.chats_db import get_all_chats
...
Here are some links for you
    ...
    buttons.add(
        InlineKeyboardButton(
            'Support Channel', url='https://t.me/CynicsBotHelp',
        ),
        InlineKeyboardButton(
            'Repository', url='https://github.com/pokurt/Cynics-Remix',
        ),
        InlineKeyboardButton('Support', url='https://t.me/Cynicsbotsupport'),
    )
...
async def get_myself(client, message):
    ...
    text += f' - **Cynics Version**: `v{USERBOT_VERSION}`\n'
    ...
    if me.photo:
        getpp = await client.download_media(
            ...
            file_name='Cynics/downloads/pfp.png',
        )
        await message.reply_photo(
            photo=getpp,
            caption=text,
