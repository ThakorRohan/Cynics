...
async def download_url(url, file_name):
    ...
    try:
        os.rename(downloader.file_name, 'Cynics/downloads/' + file_name)
    except OSError:
...
async def download_reply_nocall(client, message):
    if message.reply_to_message.photo:
        ...
        await client.download_media(
            message.reply_to_message.photo, file_name='Cynics/downloads/' + nama,
        )
        ...
        await client.download_media(
            message.reply_to_message.video, file_name='Cynics/downloads/' + nama,
        )
        ...
        await client.download_media(
            message.reply_to_message.audio, file_name='Cynics/downloads/' + nama,
        )
    elif message.reply_to_message.voice:
        nama = f'audio_{message.reply_to_message.voice.date}.ogg'
        await client.download_media(
            message.reply_to_message.voice, file_name='Cynics/downloads/' + nama,
        )
...
async def download_file_from_tg(client, message):
    ...
    if message.reply_to_message.photo:
        await client.download_media(
            ...
            file_name='Cynics/downloads/' + name,
    ...
    text += '🏷 Saved to: `Cynics/downloads/`\n'
