from Cynics import AdminSettings, COMMAND_PREFIXES, edit_or_reply, app
from pyrogram import filters, errors
from pyrogram.types import ChatPermissions
from Cynics.utils.capture_errors import capture_err
from Cynics.utils.string import extract_time
from Cynics.utils.parser import user_time_and_reason, time_parser_int
...
@app.on_message(filters.command('tmute', COMMAND_PREFIXES) & filters.user(AdminSettings))
@capture_err
