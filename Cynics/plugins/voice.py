...
from Cynics import IBM_WATSON_CRED_PASSWORD
from Cynics import IBM_WATSON_CRED_URL
from Cynics.plugins.downloads import download_reply_nocall
...
async def voice(client, message):
    ...
    tts.save('Cynics/cache/voice.ogg')
    await message.delete()
    if message.reply_to_message:
        await client.send_voice(
            message.chat.id,
            voice='Cynics/cache/voice.ogg',
            reply_to_message_id=message.reply_to_message.message_id,
        )
    else:
        await client.send_voice(message.chat.id, voice='Cynics/cache/voice.ogg')
    await client.send_chat_action(message.chat.id, action='cancel')
    os.remove('Cynics/cache/voice.ogg')
