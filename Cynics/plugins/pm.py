...
async def pm_button(client, query):
    ...
    if re.match('engine_pm_block', query.data):
        ...
        await app.send_message(
            query.from_user.id,
            'Hello, if you want to report any bugs, visit @CynicsBotSupport.',
        )
        ...
        await app.send_message(
            target, 'Hello, this is **Cynics**, my master approved you to PM.',
        )
