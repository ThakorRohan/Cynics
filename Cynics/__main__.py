...
from Cynics import get_self
from Cynics import get_bot
from Cynics.plugins.assistant import ALL_SETTINGS
from Cynics.plugins import ALL_MODULES

try:
    from Cynics import TEST_DEVELOP
except ImportError:
    TEST_DEVELOP = False
...
async def reload_userbot():
    ...
    for modul in ALL_MODULES:
        imported_module = importlib.import_module('Cynics.plugins.' + modul)
...
async def reboot():
    ...
    importlib.reload(importlib.import_module('Cynics.plugins'))
    importlib.reload(importlib.import_module('Cynics.plugins.assistant'))
    ...
    for setting in ALL_SETTINGS:
        imported_module = importlib.import_module(
            'Cynics.plugins.assistant.' + setting,
        )
        importlib.reload(imported_module)
    # Cynics userbot
    for modul in ALL_MODULES:
